...
<aside>
📢 시나리오
관리자는 새롭게 추가한 5GB 디스크(`/dev/nvme0n2`) 중 2GB만 `/backup`으로 사용하고 있습니다. 이제 남은 **3GB의 파티션 공간**을 활용하여, 시스템 로그 데이터가 급증할 경우를 대비한 **로그 전용 저장소(`/logdata`)**를 구축하고 시스템 운영의 안정성을 확보하십시오.
